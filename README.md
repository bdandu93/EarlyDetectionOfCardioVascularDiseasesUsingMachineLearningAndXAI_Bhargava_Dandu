...
```
cd existing_repo
git remote add origin https://gitlab.comp.dkit.ie/D00274867/masters-project.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.comp.dkit.ie/D00274867/masters-project/-/settings/integrations)
